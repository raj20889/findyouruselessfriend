      ...
      <Card className="mt-8 w-full max-w-4xl p-6 bg-card/70 backdrop-blur-lg shadow-2xl border-primary/20">
        <CardContent className="p-0">
          <div className="flex flex-col items-center gap-4">
            ...
            <h3 className="text-xl font-semibold">First, who are you?</h3>
            <RadioGroup
              defaultValue={gender}
            ...
            >
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="girl" id="r-girl" />
                <Label htmlFor="r-girl" className="text-lg">I am a Girl</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="boy" id="r-boy" />
                <Label htmlFor="r-boy" className="text-lg">I am a Boy</Label>
              </div>
            </RadioGroup>
          </div>
                  ...
                  {files[key].preview ? (
                    ...
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                      ...
                      <p className="text-xs text-muted-foreground/80">
                        {index < 2 ? `Photo of you or a friend` : `Photo of opposite gender`}
                      </p>
                    </div>
                  )}
                  <input
